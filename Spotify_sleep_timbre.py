...
#    'ASMR Sleep' : ('Spotify', '37i9dQZF1DWUAeTOoyNaqm'),
        # 2021 revisit - from the features script, this one was missing tracks, the only one, suggesting
        # it might be our culprit...
...
#    'Sad songs for crying yourself to sleep' : ('Indiemono', '7ABD15iASBIpPP5uJ5awvq'),
    ...
    'lofi sleep, lofi rain' : ('colours in the dark', '35xI4hSJ8MdO1xkXwsd56a')
}

sleep_playlists_df = analyze_playlist_dict(sleep_playlists_dict)

sleep_playlists_df.to_csv('sleep_playlists_timbres.csv')
